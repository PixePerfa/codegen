# Setup Scheduled Task for Windows to WSL2 Sync (Fixed Version)
...
if ($LASTEXITCODE -ne 0) {
    Write-Error "WSL is not accessible. Make sure WSL2 is installed and running."
    exit 1
}
...
if (-not $distroExists) {
    Write-Error "WSL distribution '$DistroName' not found. Available distributions:"
    Write-Error $wslCheck
    exit 1
}
